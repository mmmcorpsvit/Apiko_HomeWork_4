...
const App = () => {
    ...
    const setMovieType2 = (movie_type) => {
    ...
    const FetchDataFromServer = () => FetchData(TV_SHOW_TYPE[movie_type].url, setListData, setIsLoading);
            ...
            <Navbar bg="dark" variant="dark" expand="sm" sticky="top">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <Nav className="mr-auto">
                        <TVShowTypeSwitcher movie_type={movie_type} onChangeHandle={setMovieType2}/>
                    </Nav>
